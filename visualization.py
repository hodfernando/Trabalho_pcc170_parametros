...
# printar os targets unicos
def unique(list1):
    x = np.array(list1)
    print(np.unique(x))

cwd = os.getcwd() # saber em qual pasta esta
features, labels = load_svmlight_file(cwd + "/Teste_1/data/data") # abre os dados
# print(features)
unique(labels) #  mostra quais os targets
...
# Tentativa de chamar o script dentro de outro script
